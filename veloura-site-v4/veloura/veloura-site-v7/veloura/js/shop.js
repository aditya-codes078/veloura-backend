...
(function () {
  ...
  // The 12 3D varieties don't each have their own checkout SKU, so the size
  // maps onto the closest real product; the variety + flavour are kept as a
  // label on the cart line so the parlour knows exactly what to make.
